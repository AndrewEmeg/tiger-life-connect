...
const SectionCard: React.FC<SectionCardProps> = ({
    ...
    return (
        <Link
            to={to}
            className={`block bg-gradient-to-br ${gradient} rounded-xl shadow-lg p-6 text-left transition-all duration-300 hover:shadow-xl hover:scale-[1.02] h-full ${className}`}
        >
