...
const ProductDetail: React.FC = () => {
  ...
  if (error || !product) {
    return (
      <div className="flex flex-col items-center justify-center h-screen">
        <p className="text-lg text-red-600 mb-4">Failed to load product details.</p>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <Link to="/marketplace" className="flex items-center mb-6 text-primary hover:underline">
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Posted {formatDistanceToNow(new Date(product.created_at), { addSuffix: true })}
              </p>
            </div>
          </div>
