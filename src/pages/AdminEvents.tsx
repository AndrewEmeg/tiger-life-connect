...
const AdminEvents = () => {
    ...
    const { user } = useAuth();
    const { events, isLoading, updateEvent, deleteEvent, isAdmin } =
        useEvents();
    ...
    const handleApprove = (id: string, currentStatus: boolean) => {
        updateEvent.mutate({ id, is_approved: !currentStatus });
    };
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="mb-6 flex gap-2">
                <Button
                    ...
                    className={
                        filter === "pending"
                            ? "bg-tigerGold text-tigerBlack hover:bg-tigerGold/90"
                            : ""
                    }
                >
                    Pending
