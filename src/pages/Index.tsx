...
import SectionCard2 from "@/components/SectitonCard2";
        ...
        <div className="max-w-6xl mx-auto w-full">
            ...
            <div className="mb-10 text-center sm:text-left">
                <h1 className="text-3xl md:text-4xl font-bold mb-2 break-words">
                    Welcome to <span className="text-primary">Tiger Life</span>,{" "}
                    {firstName}!
                </h1>
                <p className="text-lg text-gray-600">
                    The all-in-one platform for Grambling State University
                    students.
                </p>
            </div>
            ...
            <div className="bg-gray-100 rounded-xl p-6 md:p-8 mb-10">
                <h2 className="text-2xl font-bold mb-4">
                    Campus Life at Grambling State
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <p className="text-gray-700 mb-4">
                            Tiger Life helps you connect with the vibrant
                            Grambling State University community through:
                        </p>
                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                            <li>
                                Peer-to-peer marketplace for affordable
                                essentials
                            </li>
                            <li>
                                Student-provided services to help you succeed
                            </li>
                            <li>
                                Campus events to keep you engaged and informed
                            </li>
                            <li>
                                Direct messaging to connect with other Tigers
                            </li>
                        </ul>
                    </div>
                    <div className="bg-tigerGold rounded-lg p-6 text-tigerBlack">
                        ...
                        <p className="mb-4">
                            Join Tiger Life to find everything you need - from
                            textbooks and supplies to events and services!
                        </p>
                        <div className="flex justify-end">
                            <Button
                                ...
                                asChild
                            >
                                <Link to="/marketplace">Learn More</Link>
                            </Button>
                        </div>
                    </div>
                </div>
            ...
            <div className="text-center mb-12">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto mb-6">
                    Tiger Life is built by students, for students. Create
                    listings, browse services, or discover events to make the
                    most of your time at Grambling State.
                </p>
